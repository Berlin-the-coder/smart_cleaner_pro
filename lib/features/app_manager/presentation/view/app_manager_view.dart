...
import 'package:smart_cleaner_pro/core/widgets/pressable.dart';
...
class _BottomNav extends StatelessWidget {
  ...
  static const _labelKeys = ['home', 'files', 'apps', 'settings'];
            ...
            body: state.when(
              ...
              loaded: (apps, sortOrder) => Stack(
                children: [
                  ...
                  if (ref.watch(appManagerIconsLoadingProvider))
                    Positioned(
                      top: MediaQuery.of(context).padding.top + 8,
                      right: 16,
                      child: const _IconsLoadingBadge(),
                    ),
                ],
              ),
...
// ─── Small "loading icons…" badge, shown while Phase 2 runs ─────────────────
class _IconsLoadingBadge extends StatelessWidget {
  const _IconsLoadingBadge();
