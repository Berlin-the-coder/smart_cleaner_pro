        ...
        body: state.when(
          ...
          scanned: (groups) => Column(
            children: [
              ...
              if (ref.watch(duplicateFinderScanningProvider))
                const _StillScanningBanner(),
              Expanded(
                child: _ScannedView(
                  groups: groups,
...
// ─── RESULTS HEADER ───────────────────────────────────────────────────────────
// ─── Small banner shown while duplicate results keep streaming in ───────────
class _StillScanningBanner extends StatelessWidget {
  const _StillScanningBanner();
